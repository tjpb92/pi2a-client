 ...
 * d'événements dans le cas du bug du 27 octobre 2023 avec la non détection de
 * l'événnement ContactNotifiedOfSupport.
 *
 * @author Thierry Baribaud
 * @version 0.32.10
 */
public class ContactNotifiedOfSupportTest {
    ...
    public ContactNotifiedOfSupportTest() {
    }
    ...
    /**
     * Programme permettant de tester le comportement du programme d'extraction
     * d'événements dans le cas du bug du 27 octobre 2023 avec la non
     * détection de l'événnement ContactNotifiedOfSupport.
     */
    @Test
...
//        String json;
        int i;
        ContactNotifiedOfSupport contactNotifiedOfSupport;

        System.out.println("ContactNotifiedOfSupportTest");
        ...
        try {
            ...
            // from=2023-10-27T09:08:30Z&to=2023-10-27T09:09:40Z
            from = "2023-10-27T09:08:30Z";
            to = "2023-10-27T09:09:40Z";
...
//            range.setOffset(0);
            ...
            for (Event event : events) {
                ...
                if (event instanceof ContactNotifiedOfSupport) {
                    contactNotifiedOfSupport = (ContactNotifiedOfSupport) event;
...
//            }
            ...
            Logger.getLogger(ContactNotifiedOfSupportTest.class.getName()).log(Level.SEVERE, null, ex);
            fail(ex.getMessage());
        } catch (Exception ex) {
            Logger.getLogger(ContactNotifiedOfSupportTest.class.getName()).log(Level.SEVERE, null, ex);
        }
