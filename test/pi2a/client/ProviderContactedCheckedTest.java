 ...
 * d'événements dans le cas du bug du 7 août 2023 avec la non détection de
 * l'événnement ProviderContactedChecked.
 *
 * @author Thierry Baribaud
 * @version 0.32.7
 */
public class ProviderContactedCheckedTest {
    ...
    public ProviderContactedCheckedTest() {
    }
     ...
     */
    @Test
    public void testProviderContactedChecked() {
...
//        String json;
        int i;
        ProviderContactedChecked providerContactedChecked;

        System.out.println("ProviderContactedCheckedTest");
        ...
        try {
            ...
            // from=2023-08-07T10:19:41Z to=2023-08-07T10:20:46Z
            from = "2023-08-07T10:19:41Z";
            to = "2023-08-07T10:20:46Z";
...
//            range.setOffset(0);
            ...
            for (Event event : events) {
                ...
                if (event instanceof ProviderContactedChecked) {
                    providerContactedChecked = (ProviderContactedChecked) event;
                    System.out.println("    " + providerContactedChecked);
                }
            }
...
//            }
            ...
            Logger.getLogger(ProviderContactedCheckedTest.class.getName()).log(Level.SEVERE, null, ex);
            fail(ex.getMessage());
        } catch (Exception ex) {
            Logger.getLogger(ProviderContactedCheckedTest.class.getName()).log(Level.SEVERE, null, ex);
        }
