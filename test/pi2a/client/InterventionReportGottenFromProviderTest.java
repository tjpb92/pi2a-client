 ...
 * d'événements dans le cas du bug du 11 août 2023 avec la non détection de
 * l'événnement InterventionReportGottenFromProvider.
 *
 * @author Thierry Baribaud
 * @version 0.32.8
 */
public class InterventionReportGottenFromProviderTest {
    ...
    public InterventionReportGottenFromProviderTest() {
    }
     ...
     */
    @Test
    public void testInterventionReportGottenFromProvider() {
...
//        String json;
        int i;
        InterventionReportGottenFromProvider interventionReportGottenFromProvider;

        System.out.println("InterventionReportGottenFromProviderTest");
        ...
        try {
            ...
            // from=2023-08-11T09:15:45Z&to=2023-08-11T09:16:53Z
            from = "2023-08-11T09:15:45Z";
            to = "2023-08-11T09:16:53Z";
...
//            range.setOffset(0);
            ...
            for (Event event : events) {
                ...
                if (event instanceof InterventionReportGottenFromProvider) {
                    interventionReportGottenFromProvider = (InterventionReportGottenFromProvider) event;
                    System.out.println("    " + interventionReportGottenFromProvider);
                }
            }
...
//            }
            ...
            Logger.getLogger(InterventionReportGottenFromProviderTest.class.getName()).log(Level.SEVERE, null, ex);
            fail(ex.getMessage());
        } catch (Exception ex) {
            Logger.getLogger(InterventionReportGottenFromProviderTest.class.getName()).log(Level.SEVERE, null, ex);
        }
