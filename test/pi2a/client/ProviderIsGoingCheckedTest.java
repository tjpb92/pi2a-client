 ...
 * l'événnement ProviderIsGoingChecked.
 *
 * @author Thierry Baribaud
 * @version 0.32.7
 */
public class ProviderIsGoingCheckedTest {
    ...
    public ProviderIsGoingCheckedTest() {
    }
     ...
     */
    @Test
    public void testProviderIsGoingChecked() {
...
//        String json;
        ...
        System.out.println("ProviderIsGoingCheckedTest");
        ...
        try {
            ...
            // from=2023-08-07T09:52:57Z&to=2023-08-07T09:54:07Z
            from = "2023-08-07T09:52:57Z";
            to = "2023-08-07T09:54:07Z";
...
//            range.setOffset(0);
            ...
            for (Event event : events) {
                ...
                if (event instanceof ProviderIsGoingChecked) {
                    providerIsGoingChecked = (ProviderIsGoingChecked) event;
                    System.out.println("    " + providerIsGoingChecked);
                }
            }
...
//            }
            ...
            Logger.getLogger(ProviderIsGoingCheckedTest.class.getName()).log(Level.SEVERE, null, ex);
            fail(ex.getMessage());
        } catch (Exception ex) {
            Logger.getLogger(ProviderIsGoingCheckedTest.class.getName()).log(Level.SEVERE, null, ex);
        }
