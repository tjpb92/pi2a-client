 ...
 * d'événements dans le cas du bug du 21 août 2023 avec la non détection de
 * l'événnement InterventionReportGottenFromResident.
 *
 * @author Thierry Baribaud
 * @version 0.32.8
 */
public class InterventionReportGottenFromResidentTest {
    ...
    public InterventionReportGottenFromResidentTest() {
    }
     ...
     */
    @Test
    public void testInterventionReportGottenFromResident() {
...
//        String json;
        int i;
        InterventionReportGottenFromResident interventionReportGottenFromResident;

        System.out.println("InterventionReportGottenFromResidentTest");
        ...
        try {
            ...
            //from=2023-08-21T08:16:30Z&to=2023-08-21T08:17:36Z
            from = "2023-08-21T08:16:30Z";
            to = "2023-08-21T08:17:36Z";
...
//            range.setOffset(0);
            ...
            for (Event event : events) {
                ...
                if (event instanceof InterventionReportGottenFromResident) {
                    interventionReportGottenFromResident = (InterventionReportGottenFromResident) event;
                    System.out.println("    " + interventionReportGottenFromResident);
                }
            }
...
//            }
            ...
            Logger.getLogger(InterventionReportGottenFromResidentTest.class.getName()).log(Level.SEVERE, null, ex);
            fail(ex.getMessage());
        } catch (Exception ex) {
            Logger.getLogger(InterventionReportGottenFromResidentTest.class.getName()).log(Level.SEVERE, null, ex);
        }
